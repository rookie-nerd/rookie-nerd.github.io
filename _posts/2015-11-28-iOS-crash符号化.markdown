...
0000000100000000 T __mh_execute_header
                 ...
                 U dyld_stub_binder
```
仔细观察两者的差别，可以发现strip之后，a.stripped.out文件比a.out小了，其中很多符号被移除了，比如\_main,GCC_except_table2等。一般正式发布的二进制都会将将符号表strip，以便减少安装包的大小。
...
# Further Reading
+ [Understanding and Analyzing Application Crash Reports](https://developer.apple.com/library/ios/technotes/tn2151/_index.html)
